               ...
               <div class="alert alert-success alert-dismissible fade show" role="alert">
                   ...
                   <button type="button" class="close" data-dismiss="alert" aria-label="Close">
					...
					<div style="margin-top:50px" class="col-md-6">
                      ...
                      Name of asset: <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" autofocus>
                    ...
                    <div style="margin-top:50px" class="col-md-6">
                       Price $ : <input id="price" type="text" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price" value="{{ old('price') }}" autofocus>
                      ...
                      <div style="margin-top:50px" class="col-md-6">
                       Quantity (optional): <input id="quantity" type="text" class="form-control" name="quantity" value="{{ old('quantity') }}" autofocus>
                    ...
                    <div class="col-md-12">
                   <input style="margin-top:50px" id="submit" class="btn btn-primary btn-md" type="submit" class="form-control" name="submit" value="Create new Asset" required />
               </div>
            </div>
        </form>
