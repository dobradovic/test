...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<form method="POST" action="/investment/store">
				@csrf
               ...
               <div class="alert alert-success alert-dismissible fade show" role="alert">
                   ...
                   <button type="button" class="close" data-dismiss="alert" aria-label="Close">
					...
					<div style="margin-top:50px" class="col-md-6">
                      ...
                      Name of investment: <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" autofocus>
                    ...
                    <div class="col-md-12">
                   <input style="margin-top:50px" id="submit" class="btn btn-primary btn-md" type="submit" class="form-control" name="submit" value="Create new Investment" required />
               </div>
            </div>
        </form>
